...
import (
	"errors"
	"github.com/apiotrowski312/isOnline-oauth-api/src/clients/cassandra"
	"github.com/apiotrowski312/isOnline-oauth-api/src/domain/access_token"
...
func (r *dbRepository) GetById(id string) (*access_token.AccessToken, rest_errors.RestErr) {
	...
	if err := cassandra.GetSession().Query(queryGetAccessToken, id).Scan(
		...
		if err == gocql.ErrNotFound {
			return nil, rest_errors.NewNotFoundError("Not found a user with given ID")
		}
